    ...
    <div className={` flex justify-center items-center space-x-2 mt-6`}>
        ...
        return (
          <button
            ...
            className={`w-6 h-6 border text-xs font-semibold  rounded-md ${
              page === currentPage ? "bg-blue-500 text-white hover:bg-blue-600 " : "bg-gray-100 hover:bg-gray-300"
            }`}
          >
            {page}
          </button>
      ...
      <button
        ...
        className={`${currentPage === totalPages ? "hidden" : "block"} ${
          currentPage === totalPages ? `${tailwindStyles.thirdButton} cursor-not-allowed` : tailwindStyles.secondaryButton
        }`}
      >
