    ...
    <div className="flex flex-col gap-2 items-center lg:flex-row-reverse w-full space-y-0 lg:space-y-4">
      ...
      {mainImage ? (
        <img
          src={mainImage}
          alt="Property"
          className="w-[80%] h-32 object-cover md:h-54 lg:h-60 rounded-lg"
        />
      ) : (
        ...
        {property.images && property.images.length > 0 ? (
          property.images.slice(0, 5).map((img, index) => (
            <img
              ...
              className={`min-w-12 min-h-12 max-w-12 max-h-12 lg:min-w-14 lg:min-h-14 lg:max-w-14 lg:max-h-14 object-fit rounded-lg cursor-pointer hover:border-2 hover:border-blue-500 ${
