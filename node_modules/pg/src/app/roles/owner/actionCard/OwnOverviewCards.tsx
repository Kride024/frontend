...
export default function Dashboard() {
  ...
  // Cards (declared here so recomputeLayout can use cards.length)
  ...
  function OccupancyCard(key?: string) {
    return (
      <article
        key={key ?? "occupancy"}
        ...
        style={{
          width: CARD_WIDTH,
          height: "487px",
          border: "1px solid rgba(79, 107, 227, 0.0)",
          background: "#FFF",
          ...
          <div className="flex-1 flex flex-col items-center justify-center mt-3">
            ...
            <div className="mt-2 text-center p-2" style={{ width: "100%" }}>
              ...
              <div className="mt-19 flex items-center justify-center gap-2">
                ...
                >
                  <span className="text-[#10BA2A] font-semibold mr-1">10%</span>{" "}
                  vs last month
                </div>
              </div>
            </div>
  ...
  function ActiveGuestsCard(key?: string) {
    return (
      <article
        key={key ?? "active"}
        className="rounded-[30px] flex-shrink-0 active-guests-card"
        style={{
          width: CARD_WIDTH,
          height: "487px",
          border: "1px solid rgba(79, 107, 227, 0.0)",
          ...
          <div className="flex-1 flex flex-col items-center justify-center">
            ...
            <div className="flex gap-4 mt-7 items-center justify-center">
              <div className="flex items-center gap-2">
                <div
                  className="flex-shrink-0 ml-[-10px]"
                  style={{
                    width: "10px",
                    height: "10px",
                    transform: "rotate(-90.749deg)",
                  }}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="mt-15 text-center p-2" style={{ width: "100%" }}>
              <div className=" flex items-center justify-center gap-2">
                <div
                  ...
                  className="font-Poppins text-gray-900"
                >
                  <span className="text-[#10BA2A] font-semibold mr-1 ">7%</span> vs last
                  month
                </div>
              </div>
            </div>
  ...
  function RevenueCard(key?: string) {
    return (
      <article
        key={key ?? "revenue"}
      ...
      >
        ...
        >
          ...
          <div className="mt-6 text-center">
            <div className="flex items-center justify-center gap-2">
              <div
                className="text-[15px] mt-[-20px] font-Poppins font-medium text-gray-900 "
  ...
  function OverdueCard(key?: string) {
    return (
      <article
        key={key ?? "overdue"}
        className="rounded-[30px] flex-shrink-0"
      ...
      >
        ...
        >
          ...
          <div className="flex-1 flex flex-col items-center justify-center">
            <div
              className="relative"
              style={{ width: "163px", height: "162px", flexShrink: 0 }}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="163"
            ...
            <div className="mt-4 flex flex-col items-start gap-3 w-full px-6">
              <div className="flex items-center gap-3">
                <div
                  style={{ width: "10px", height: "10px", borderRadius: 9999 }}
                  className="bg-[#5B93FF]"
                />
                <div
                  className="font-semibold"
  ...
  const goRight = () =>
    setStartIndex((s) => Math.min(cards.length - visibleCount, s + 1));
